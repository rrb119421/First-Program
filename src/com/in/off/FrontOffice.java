		...
		while(true) {
			...
			case 2:{//select Employee
				...
				case 2:{//select by eid
					System.out.println("enter eid");
					LinkedHashSet<Employee> lhs=cmp.getByEid(scn.nextInt());scn.nextLine();
					if(lhs.isEmpty()) {
				...
				case 3:{
					System.out.println("enter ename");
					LinkedHashSet<Employee> lhs=cmp.getByEname(scn.nextLine());scn.nextLine();
					if(lhs.isEmpty()) {
				...
				case 4: {
					System.out.println("enter dept");
					LinkedHashSet<Employee> lhs=cmp.getEmployeeByDept(scn.nextLine());scn.nextLine();
					if(lhs.isEmpty()) {
